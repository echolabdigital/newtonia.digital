<?php
/**
 * Newton IA — Banner LGPD / Cookie Consent
 *
 * Incluir ANTES do </body> em todas as páginas públicas.
 * O banner aparece apenas se o cookie "newton_lgpd_ok" não estiver setado.
 *
 * Uso:
...
<div id="lgpd-banner" style="display:none;position:fixed;bottom:0;left:0;right:0;z-index:9999;
  ...
  <div style="flex:1;min-width:260px">
    <span style="font-family:'Geist Mono',monospace;font-size:.6rem;color:#0ea5e9;text-transform:uppercase;letter-spacing:.08em;margin-right:8px">// LGPD</span>
    Usamos apenas cookies essenciais para manter sua sessão ativa. Não rastreamos você para fins publicitários.
    <a href="/privacy.php" style="color:#0ea5e9;text-decoration:none;margin-left:6px;white-space:nowrap">Política de Privacidade →</a>
  </div>
  <div style="display:flex;gap:8px;flex-shrink:0">
    ...
    <button onclick="lgpdAccept()" style="padding:8px 18px;border-radius:7px;background:#0ea5e9;border:none;color:#fff;font-weight:600;cursor:pointer;font-family:inherit;font-size:.84rem;white-space:nowrap">Entendi →</button>
  </div>
</div>
...
function lgpdAccept() {
  ...
  document.cookie = 'newton_lgpd_ok=1; expires=' + d.toUTCString() + '; path=/; SameSite=Lax';
  var b = document.getElementById('lgpd-banner');
  if (b) {
